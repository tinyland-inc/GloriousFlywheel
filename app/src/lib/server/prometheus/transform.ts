 ...
 */
export function toMetricValue(results: InstantResult[], defaultValue: number = 0): MetricValue {
	if (results.length === 0) {
 ...
 */
export function toValueMap(results: InstantResult[], labelKey: string = 'pod'): Record<string, number> {
