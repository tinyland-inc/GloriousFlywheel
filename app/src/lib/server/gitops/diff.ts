 ...
 */
export function computeDiff(before: TfVarsDocument, after: TfVarsDocument): ConfigDiff[] {
	const diffs: ConfigDiff[] = [];
	const allKeys = new Set([...Object.keys(before.values), ...Object.keys(after.values)]);
 ...
 */
export function unifiedDiff(before: string, after: string, filename: string = 'beehive.tfvars'): string {
